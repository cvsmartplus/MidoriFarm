...
<div class="container-fluid">
    <div class="card p-0 overflow-hidden position-relative radius-12 h-100">
      ...
      <div class="tab-pane fade show active" id="sensor-udara" role="tabpanel"
           aria-labelledby="sensor-udara-tab">
        <div class="card-body p-24"
          ...
          <div style="flex: 1; padding-right: 16px; box-sizing: border-box;">
            <div class="d-flex p-16 bg-info-50 radius-8 border-start-width-3-px border-info"
                 style="
                   height: 100%;             /* <--- no fixed px */
                   align-items: center;
                   justify-content: flex-start;
                   gap: 16px;
                 ">
              <iconify-icon icon="solar:temperature-bold" height="80"></iconify-icon>
              <div>
          ...
          <div style="flex: 1; padding-left: 16px; box-sizing: border-box;">
            <div style="
              ...
              <div class="d-flex p-16 bg-info-50 radius-8 border-start-width-3-px border-info"
                ...
                <iconify-icon icon="mdi:humidity-outline" height="60"></iconify-icon>
                <div>
              ...
              <div class="d-flex p-16 bg-info-50 radius-8 border-start-width-3-px border-info"
                   style="align-items: center; gap: 12px;">
                <iconify-icon icon="mdi:uv-ray-outline" height="60"></iconify-icon>
                <div>
              ...
              <div class="d-flex p-16 bg-info-50 radius-8 border-start-width-3-px border-info"
                   style="align-items: center; gap: 12px;">
                <iconify-icon icon="mi:rain" height="60"></iconify-icon>
                <div>
              ...
              <div class="d-flex p-16 bg-info-50 radius-8 border-start-width-3-px border-info"
                   style="align-items: center; gap: 12px;">
                <iconify-icon icon="material-symbols:air-rounded" height="60"></iconify-icon>
                <div>
