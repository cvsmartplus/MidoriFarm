...
<div class="card">
    <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
        ...
        <div class="d-flex flex-wrap align-items-center gap-3">
            ...
            <button type="button" class="btn btn-sm btn-primary-400"><i class="ri-add-line"></i> Tambah Produk</button>
        </div>
    </div>
    <div class="card-body">
                ...
                <tr>
                    ...
                    <td>
                        @if (Auth::user()->role == 'admin')
                            ...
                            <a  href="javascript:void(0)" class="w-32-px h-32-px bg-danger-focus text-primary-400 rounded-circle d-inline-flex align-items-center justify-content-center">
