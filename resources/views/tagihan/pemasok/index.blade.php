    ...
    <div class="card-body">
        <div class="table-responsive scroll-sm">
            <table class="table bordered-table sm-table mb-0" id="dataTable" cellspacing="0">
                ...
                <tbody id="table">
                    @foreach($tagihanpemasok as $key => $tagihan)
                    <tr>
                        <td class="text-center">{{$key + 1 }}</td>
                        <td class="text-center">{{$tagihan->supplier->name}}</td>
                        <td class="text-center">{{$tagihan->debt_date}}</td>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-24">
                                    <form action=""></form>
                                    <form action="{{ routeByRole('admin.tagihanPemasok.update','owner.tagihanPemasok.update', null, null, ['pemasok' => $tagihan->id]) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="date" id="debt_date" name="debt_date" class="form-control"
                                                    value="{{$tagihan->debt_date}}" placeholder="Tanggal Hutang" required>
                                            </div>
                                            <div class="col-12">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="{{ routeByRole('admin.tagihanPemasok.destroy','owner.tagihanPemasok.destroy'  , null, null, ['pemasok' => $tagihan->id]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body p-24">
                <form action="{{ routeByRole('admin.tagihanPemasok.store', 'owner.tagihanPemasok.store', null, null) }}" method="POST" class="needs-validation" novalidate>
                    @csrf
                    <div class="row">
                        <div class="col-12">
