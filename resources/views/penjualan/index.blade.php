                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-24">
                                    <form></form>
                                    <form action="{{ routeByRole('admin.assetKategori.update', 'owner.assetKategori.update',null, null, ['id' => ]) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="row">
                                            <div class="col-12">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <form action="{{ routeByRole('admin.assetKategori.destroy', 'owner.assetKategori.destroy', null, null, ['id' => ]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
