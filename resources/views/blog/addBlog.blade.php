                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header border-bottom">
                            <h6 class="text-xl mb-0">Buat Artikel Baru</h6>
                        </div>
                        <div class="card-body p-24">
                            <form action="#" class="d-flex flex-column gap-20">
                                <div>
                                    <label class="form-label fw-bold text-neutral-900" for="title">Judul Artikel </label>
                                    <input type="text" class="form-control border border-neutral-200 radius-8" id="title" placeholder="Enter Post Title">
                                </div>
                                <div>
                                    <label class="form-label fw-bold text-neutral-900">Kategori Artikel </label>
                                ...
                                <div>
                                    <label class="form-label fw-bold text-neutral-900">Deskripsi Artikel </label>
                                ...
                                <div>
                                    <label class="form-label fw-bold text-neutral-900">Unggah Thumbnail </label>
                                ...
                                <button type="submit" class="btn btn-primary-500 text-sm btn-sm px-12 py-16 w-100 radius-12 mt-32">Submit</button>
                            </form>
                        </div>
                    </div>
                </div>
