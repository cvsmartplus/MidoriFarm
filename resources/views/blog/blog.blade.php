                    ...
                    <div class="card h-100 p-0 radius-12 overflow-hidden">
                        <div class="card-body p-24">
                            <a  href="{{ route('blogDetails') }}" class="w-100 max-h-194-px radius-8 overflow-hidden">
                                <img src="{{ asset('assets/images/blog/blog4.png') }}" alt="" class="w-100 h-100 object-fit-cover">
                            </a>
                            <div class="mt-20">
                            ...
                            <div class="p-20">
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-6">
                                    <div class="d-flex align-items-center gap-8">
                                        <img src="{{ asset('assets/images/user-list/user-list1.png') }}" alt="" class="w-40-px h-40-px rounded-circle object-fit-cover">
                    ...
                    <div class="card h-100 p-0 radius-12 overflow-hidden">
                        <div class="card-body p-0">
                            ...
                            <div class="p-20">
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-6">
                                    <div class="d-flex align-items-center gap-8">
                                        <img src="{{ asset('assets/images/user-list/user-list2.png') }}" alt="" class="w-40-px h-40-px rounded-circle object-fit-cover">
                                        <div class="d-flex flex-column">
                    ...
                    <div class="card h-100 p-0 radius-12 overflow-hidden">
                        <div class="card-body p-0">
                            ...
                            <div class="p-20">
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-6">
                                    <div class="d-flex align-items-center gap-8">
                                        <img src="{{ asset('assets/images/user-list/user-list3.png') }}" alt="" class="w-40-px h-40-px rounded-circle object-fit-cover">
                                        <div class="d-flex flex-column">
                                            <h6 class="text-sm mb-0">John Doe</h6>
                                            <span class="text-xs text-neutral-500">1 day ago</span>
                                        </div>
