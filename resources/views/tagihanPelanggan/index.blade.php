        ...
        <table class="table bordered-table mb-0">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <a  href="{{ route("admin.tagihan.show") }}" class="w-32-px h-32-px bg-primary-light text-primary-600 rounded-circle d-inline-flex align-items-center justify-content-center">
